// Double-submit CSRF check: the client echoes the readable csrfToken cookie
...
// SameSite=None in prod) but can't read csrfToken to forge the matching
// header. Only applied to state-changing methods, matching convention —
// except GET /api/rooms/join/:code, which (unusually) has a real side
// effect (auto-joins the requester as a room member).
