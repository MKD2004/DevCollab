            ...
            <div className="flex items-center justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-background/70 mb-8 leading-relaxed max-w-lg">
                  Create a room, share the join code, and watch your team's
                  cursors show up live. Free, no credit card.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4">
                  ...
                  >
                    <a href="https://github.com/MKD2004/DevCollab" target="_blank" rel="noreferrer">
                      View source
                    </a>
                  </Button>
                </div>
